...
function App() {
  return (
    <div className="App">
    <Header></Header>
    <Paper sx={{width:'100vw', marginBottom:'80px', background: 'linear-gradient(to top, #ffff 0%, #ffff 1%, #EBE8FC 100%);', border:'1px solid #2c6fbb', borderRadius:'15px 15px'}} elevation={5} square>
